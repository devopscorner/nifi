...
main() {
  # docker_build alpine Dockerfile.alpine 3.16 devopscorner/nifi
  # docker_build ubuntu Dockerfile.ubuntu 22.04 devopscorner/nifi
  # docker_build codebuild Dockerfile.codebuild 4.0 devopscorner/nifi
