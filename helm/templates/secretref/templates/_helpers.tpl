...
*/}}
{{- define "secretref.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "secretref.fullname" .) .Values.serviceAccount.name }}
{{- else }}
